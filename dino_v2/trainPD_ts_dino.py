...
# parser.add_argument('--exp_name', default='trainPD_ts_burnIn_reg_0.3_dinov2', type=str, help='experiment name, used for model saving/plotting/wand ect' )
parser.add_argument('--exp_name', default='trainPD_ts_burnIn_400_reg_0.3_final_dinov2', type=str, help='experiment name, used for model saving/plotting/wand ect' )
...
parser.add_argument('--data_path', default = './TRI_PD/TRI_PD_train', type = str, help = 'path of PD dataset')
...
def main():
    ...
    # test_set = PDDataset(split = 'eval', root = data_path, supervision = opt.supervision, transform=None, apply_img_transform=True)
    ...
    step = 0
    best_ckpt = 400
    burn_in_exp = 'trainPD_ts_burnIn_reg_0.3_dinov2'
