...
class Encoder(nn.Module):
    def __init__(self, resolution, hid_dim, input_channels):
        super().__init__()
        self.resolution = resolution
        self.hid_dim = hid_dim
        self.input_channels = input_channels
        self.resnet = resnet.resnet18(pretrained=False, input_channels=input_channels)
...
class Decoder(nn.Module):
    def __init__(self, hid_dim, resolution, output_channel):
        ...
        # self.conv6 = nn.ConvTranspose2d(hid_dim, output_channel, 3, stride=(1, 1), padding=1) #TODO:reset
        self.conv6 = nn.ConvTranspose2d(hid_dim, output_channel, output_channel, stride=(1, 1), padding=1)
        self.resolution = resolution
...
class SlotAttentionAutoEncoder(nn.Module):
    def __init__(self, resolution, num_slots, hid_dim, output_channel = 4):
        ...
        self.encoder_cnn = Encoder(self.resolution, self.hid_dim, self.output_channel)
